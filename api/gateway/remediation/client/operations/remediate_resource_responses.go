...
func (o *RemediateResourceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRemediateResourceOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewRemediateResourceBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewRemediateResourceInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *RemediateResourceOK) Error() string {
	return fmt.Sprintf("[POST /remediate][%d] remediateResourceOK ", 200)
}

func (o *RemediateResourceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRemediateResourceBadRequest() *RemediateResourceBadRequest {
	return &RemediateResourceBadRequest{}
}
...
func (o *RemediateResourceBadRequest) Error() string {
	return fmt.Sprintf("[POST /remediate][%d] remediateResourceBadRequest  %+v", 400, o.Payload)
}
...
func (o *RemediateResourceBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRemediateResourceInternalServerError() *RemediateResourceInternalServerError {
	return &RemediateResourceInternalServerError{}
}
...
func (o *RemediateResourceInternalServerError) Error() string {
	return fmt.Sprintf("[POST /remediate][%d] remediateResourceInternalServerError ", 500)
}

func (o *RemediateResourceInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
