...
type Anomaly struct {
	...
	Proto        *string            `json:"proto,omitempty" description:"Suricata Anomaly Proto"`
	...
	Timestamp    *string            `json:"timestamp" validate:"required" description:"Suricata Anomaly Timestamp"`
