...
from ...src.app.remediations.aws_ddb_encrypt_table import AwsDdbEncryptTable
...
class TestAwsDdbEncryptTable(TestCase):
    ...
    def test_fix(self, mock_session: mock.MagicMock) -> None:
        ...
        mock_client.update_table.assert_called_once_with(TableName='TestName', SSESpecification={'Enabled': True, 'SSEType': 'KMS'})
