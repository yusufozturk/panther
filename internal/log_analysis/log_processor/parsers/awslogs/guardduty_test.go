...
func TestGuardDutyLogIAMUserLoggingConfigurationModified(t *testing.T) {
	...
	expectedEvent := &GuardDuty{
		...
		Resource:    testutil.NewRawMessage(`{"resourceType":"AccessKey","accessKeyDetails":{"accessKeyId":"GeneratedFindingAccessKeyId","principalId":"GeneratedFindingPrincipalId","userType":"IAMUser","userName":"GeneratedFindingUserName"}}`), // nolint(lll)
		Service: &GuardDutyService{
			AdditionalInfo: testutil.NewRawMessage(`{"recentApiCalls":[{"count":2,"api":"GeneratedFindingAPIName1"},{"count":2,"api":"GeneratedFindingAPIName2"}],"sample":true}`),                                                                                                                                                                                                                                                                                                                                                                    // nolint(lll)
			Action:         testutil.NewRawMessage(`{"actionType":"AWS_API_CALL","awsApiCallAction":{"api":"GeneratedFindingAPIName","serviceName":"GeneratedFindingAPIServiceName","callerType":"Remote IP","remoteIpDetails":{"ipAddressV4":"198.51.100.0","organization":{"asn":"-1","asnOrg":"GeneratedFindingASNOrg","isp":"GeneratedFindingISP","org":"GeneratedFindingORG"},"country":{"countryName":"GeneratedFindingCountryName"},"city":{"cityName":"GeneratedFindingCityName"},"geoLocation":{"lat":0,"lon":0}},"affectedResources":{}}}`), // nolint(lll)
...
func TestGuardDutyLogEC2DGADomainRequest(t *testing.T) {
	...
	expectedEvent := &GuardDuty{
		...
		CreatedAt:   (*timestamp.RFC3339)(&expectedDate),
		UpdatedAt:   (*timestamp.RFC3339)(&expectedDate),
		Resource:    testutil.NewRawMessage(`{"resourceType":"Instance","instanceDetails":{"instanceId":"i-99999999","instanceType":"m3.xlarge","launchTime":"2018-08-26T14:17:23Z","instanceState":"running","availabilityZone":"GeneratedFindingInstaceAvailabilityZone","imageId":"ami-99999999","imageDescription":"GeneratedFindingInstaceImageDescription"}}`), // nolint(lll)
		Service: &GuardDutyService{
			AdditionalInfo: testutil.NewRawMessage(`{"domain":"GeneratedFindingAdditionalDomainName","sample":true}`),
			Action:         testutil.NewRawMessage(`{"actionType":"DNS_REQUEST","dnsRequestAction":{"domain":"GeneratedFindingDomainName","protocol":"0","blocked":true}}`), // nolint(lll)
			ServiceName:    aws.String("guardduty"),
			DetectorID:     aws.String("b2b7c4e8df224d1b74bece34cc2cf1d5"),
...
func TestGuardDutyLogSSHBruteForce(t *testing.T) {
	...
	expectedEvent := &GuardDuty{
		...
		CreatedAt:   (*timestamp.RFC3339)(&expectedDate),
		UpdatedAt:   (*timestamp.RFC3339)(&expectedDate),
		Resource:    testutil.NewRawMessage(`{"resourceType":"Instance","instanceDetails":{"platform":null,"tags":[{"key":"tag1","value":"val1"}],"availabilityZone":"us-east-1b","imageDescription":"Amazon Linux 2 AMI 2.0.20191217.0 x86_64 HVM gp2","instanceId":"i-081de1d7604b11e4a","instanceType":"t2.micro","launchTime":"2020-01-13T20:22:32Z","productCodes":[],"iamInstanceProfile":{"id":"AIPAQXSBWDWTIWB5KZKXA","arn":"arn:aws:iam::123456789012:instance-profile/EC2Dev"},"networkInterfaces":[{"subnetId":"subnet-48998e66","privateDnsName":"ip-172-31-81-237.ec2.internal","publicIp":"54.152.215.140","networkInterfaceId":"eni-0fd8e8a70bb7804e3","vpcId":"vpc-4a486c30","securityGroups":[{"groupName":"launch-wizard-31","groupId":"sg-0225c1ef2723cd87d"}],"ipv6Addresses":["2001:0db8:85a3:0000:0000:8a2e:0370:7334"],"publicDnsName":"ec2-54-152-215-140.compute-1.amazonaws.com","privateIpAddress":"172.31.81.237","privateIpAddresses":[{"privateDnsName":"ip-172-31-81-237.ec2.internal","privateIpAddress":"172.31.81.237"}]}],"instanceState":"running","imageId":"ami-062f7200baf2fa504"}}`), // nolint(lll)
		Service: &GuardDutyService{
			AdditionalInfo: testutil.NewRawMessage(`{}`),
			Action:         testutil.NewRawMessage(`{"actionType":"NETWORK_CONNECTION","networkConnectionAction":{"localPortDetails":{"portName":"SSH","port":22},"protocol":"TCP","blocked":false,"connectionDirection":"INBOUND","remoteIpDetails":{"ipAddressV4":"151.80.19.228","organization":{"asn":"16276","asnOrg":"OVH SAS","isp":"OVH SAS","org":"OVH SAS"},"country":{"countryName":"France"},"city":{"cityName":"Roubaix"},"geoLocation":{"lon":3.178,"lat":50.6974}},"remotePortDetails":{"port":32938,"portName":"Unknown"}}}`), // nolint(lll)
			ServiceName:    aws.String("guardduty"),
