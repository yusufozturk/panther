...
func (m *Paging) validateThisPage(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("thisPage", "body", int64(*m.ThisPage), 0, false); err != nil {
		return err
	}
...
func (m *Paging) validateTotalItems(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("totalItems", "body", int64(*m.TotalItems), 0, false); err != nil {
		return err
	}
...
func (m *Paging) validateTotalPages(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("totalPages", "body", int64(*m.TotalPages), 0, false); err != nil {
		return err
	}
